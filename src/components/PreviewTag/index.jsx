import { Container } from "../PreviewTag/styles"
import {AiFillStar} from "react-icons/ai"
import {FiStar} from "react-icons/fi"
import { Tag } from "../Tag"


export function PreviewTag({title, color}) {
    return(
        <Container {...color}>
            <h1>{title}</h1>
            <div>
            ...
            <p>Pragas nas colheitas fizeram a civilização humana regredir para uma sociedade agrária 
                ...
                na instalação da NASA, que é na realidade uma enorme estação espacial. A partida de Cooper devasta Murphy.
            </p>
            <div>
